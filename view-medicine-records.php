...
elseif (isset($_REQUEST['viewbyname'])){
    ...
    $medicineRecordRow=$con->query("select * from medicineindustry where company_name='$medName'");
    $chkRowsCount=mysqli_num_rows($medicineRecordRow);
...
<head>
    <meta charset="utf-8">
    <title>View Medicine Records - MOHA</title>
        ...
        <div class="card doctor-view">
            <div class="card-body">
                <div class="user-tabs">
                    <div style="margin-left: 30%;color: green;font-weight: 700; display: <?php if ($viewMedicineRecord==false){ echo "none";}  ?>">
                        <span>  <i class="fas fa-check" style="margin-right: 3px"></i><?php if (isset($_REQUEST['medicineID'])){?> Medicine Record By  Search ID = <?php echo $_REQUEST['med_id']; } ?>
                            <?php if (isset($_REQUEST['medicineName'])){?> Medicine Record Search  By Company Name = <?php echo $_REQUEST['medName']; ?>   <?php } ?>
                    ...
                    <div style="margin-left: 30%;color: red;font-weight: 700; ;display: <?php if ($viewMedicineRecordEmpty==false){ echo "none";}  ?>">
                        <span>  <i class="far fa-window-close" style="margin-right: 3px"></i>
                            ...
                            <?php if (isset($_REQUEST['medicineName'])){?>  No Medicine Record Avaliable By Company Name = <?php echo $_REQUEST['medName']; } ?>

                        </span>
                    </div>
                    <!--View Button Records-->
                    <div class="table-responsive medicineList2View"  style="display: <?php if($viewMedicineRecord==false){ echo "none"; }  ?>">
                        <form action="view-medicine-records.php" method="post">
                                ...
                                elseif ($chkRowsCount>1) {
                                    ...
                                    while ($row = $medicineRecordRow->fetch_array()) {
                                        ...
                                        <tr class="medicineRowView">
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="doctor-profile.html">Dr. <?php echo $row['medicine_name']; ?>
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==false){ echo "active"; } ?>" href="#med-view" data-toggle="tab" >View Medicines Records</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==true){ echo "active"; } ?> " href="#med-view-by" data-toggle="tab"><span>View Medicine Record By</span></a>
                        </li>
                ...
                <div class="tab-content">
                    ...
                    <!--Medicine View By-->
                    <div id="med-view-by" class="tab-pane fade show medicineListView <?php if ($view==true){ echo "active"; }  ?>">
                        <div class="card card-table mb-0">
                            <div class="card-body">
                                <form method="post" action="view-medicine-records.php?medicineID" style="position: relative; margin-top: 20px;">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <input type="text" class="form-control" placeholder="enter medicine id here.." name="med_id" required>
                                ...
                                <form action="view-medicine-records.php?medicineName" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <input type="text" class="form-control" placeholder="enter company name here.." name="medName" required>
