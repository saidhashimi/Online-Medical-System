...
//Search Working
$hospitalDetails=$con->query("select * from medicineindustry");
$msgN=false;
$nameShow=false;
$provinceshow=false;
$typeprovince=false;
...
if (isset($_REQUEST['search'])){
    ...
    if (($name==null) && ($location=="Select")){
        header("location:search-medicines.php");
        return;
    }elseif (!preg_match("/^[a-zA-Z ]*$/",$name)){
        $msgN=true;
    }elseif (($name!=null) && ($location=="Select")){
        $hospitalDetails=$con->query("select * from medicineindustry where medicine_name like '%$name%'");
        $nameShow=true;
    }elseif (($location!="Select") && ($name==null)){
        $hospitalDetails=$con->query("select * from medicineindustry where company_name like '%$location%'");
        $provinceshow=true;

    }elseif (($location!="Select") && ($name!=null)){
        $hospitalDetails=$con->query("select * from medicineindustry where company_name like '%$location%' and company_name like '%$location%'");
        $typeprovince=true;
...
<head>
    <meta charset="UTF-8">
    <title>Search Medicine Industry - Health Guide</title>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8 col-12">
                    <?php
                    if ($nameShow==true){
                        echo "<h3 style='color: white'> Searching: ".$name." medicine </h3>";
                    }elseif ($provinceshow==true){
                        echo "<h3 style='color: white'> Searching: medicine by ".$location." </h3>";
                    }elseif ($typeshow==true){
                        echo "<h3 style='color: white'> Searching:".$type." Medical </h3>";
                    }elseif ($typeprovince==true){
                        echo "<h3 style='color: white'> Searching: ".$name." medicine by  ".$location." </h3>";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar">
                    ...
                    <!-- Search Filter -->
                    <form action="search-medicines.php" method="get">
                                ...
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        <div class="doctor-img">
                                            <a>
                                                <img src="assets/img/services/mm.png" class="img-fluid"
                                                     alt="Doctor Image">
                                            </a>
                                        </div>
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name bg-s"><a> <?php echo $row['medicine_name']  ?> Medicine</a></h4>
                                            <br>
                                    ...
                                    <div class="doc-info-right">
                                        <div class="clini-infos">
                                            <ul>
                                                <li><i class="fas fa-check"></i> <?php  echo $row['medicine_status']; ?> by MOHA</li>

                                                <li title="Location"><i class="fas fa-building"
                                                                        data-toggle="tooltip" title="Location"></i>
                                                    <?php
                                                    echo "By ".$row['company_name'];
                                                    ?>
                                                </li>
