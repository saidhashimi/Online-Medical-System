...
//Register doctor
    if(isset($_POST['submit'])){
        ...
        $numberOfDoctors=$_POST['numberOfDoctors'];
...
//////////////////////////////////////////
        ...
        if (!preg_match("/^[a-zA-Z ]*$/",$hospitalName)){
            $msgHN=true;
            $chckH=false;
        }if ($depts!=null){
            $list=explode(",",$depts);
        ...
        }if (($chckN==true)&&($chckH==true) && ($chckD==true) && ($chckL==true) && ($chckLP==true) && ($chckLC==true) && ($chckLB==true)) {
                $insert="insert into hospital values ('','$hospitalName','$numberOfDepartments','$numberOfDoctors','$depts','$location','$contact','$status') ";
                $result=mysqli_query($con,$insert);
                if (!$result) {
                    die ("Not registered");
                } else {
                    header("location:register-successfuly.php?doctor=&&hospital=hospital&&clinic=&&medical=&&medicine=");
                }
            }
        }
...
<head>
    <meta charset="utf-8">
		<title>Hospital Registration - MOHA</title>
...
<!--/Dashboard Page Content-->
    ...
    <div class="mohaForms" id="hospitalRegistration">
				
				<form action="hospital-registration.php" method="post"> 
				<div class="card">
					<div class="card-body">
						...
						<div class="row form-row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="hospitalName" value="<?php if (isset($_REQUEST['hospitalName'])){echo $_REQUEST['hospitalName'];} ?>" minlength="5" maxlength="70" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="numberOfDepartments" value="<?php if (isset($_REQUEST['numberOfDepartments'])){echo $_REQUEST['numberOfDepartments'];} ?>" min="2" max="100" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="numberOfDoctors" min="5" max="200" value="<?php if (isset($_REQUEST['numberOfDoctors'])){echo $_REQUEST['numberOfDoctors'];} ?>" required>
                                    <div class="d-flex justify-content-between mt-1 ml-2"><small class="text-muted"><span></span></small></div>
							...
							<div class="col-md-6">
								<div class="form-group">
                                    ...
                                    <input type="text" data-role="tagsinput" class="input-tags form-control" value="<?php if (isset($_REQUEST['departments'])){echo $_REQUEST['departments'];} ?>" name="departments">
							...
							<div class="submit-section" style="position: relative; margin-left: 400px; margin-right: 400px;">
								<button type="submit" class="btn btn-primary submit-btn" name="submit">Register Hospital</button>
							...
							<div class="doctor-actions">
								<a href="delete-hospital.php" class="btn btn-sm bg-success-light">
									<i class="fas fa-trash-alt"></i> Delete Hospitals Records
								</a>
								<a href="view-hospital-records.php" class="btn btn-sm bg-info-light">
									<i class="far fa-eye"></i> View Hospitals Records
								</a>
								<a href="update-hospital-records.php" class="btn btn-sm bg-default-light">
									<i class="fas fa-edit"></i> Update Hospitals Records
								</a>
								
								<a href="hospital-registration.php" class="btn btn-sm bg-danger-light">
									<i class="fas fa-times"></i> Cancel Hospitals Registration
								</a>
