...
if (!isset($_COOKIE['username'])){
    ...
    if (isset($_REQUEST['upload'])){
        ...
        header("location:doctor-profile-setting.php?uploaded");
        return;
...
<?php
    ...
    if ($counterRecord==0){
        ...
        if (strlen($biography)<300){
            ...
            $chckBiography=false;
            $failMessage=true;
        }if (!preg_match('/^[0-9]{10}+$/',$addressLine)){
            $msgAdressLine=true;
            ...
            $subDigit=substr($addressLine,0,3);
            ...
            if ($counterRecord ==0) {
                ...
                mysqli_query($con,"update doctor set doc_contact='$addressLine',doc_location='$location' where doc_id='$doc_id'");
                mysqli_query($con, "insert into doctorprofile values ('','$biography','$addressLine',null ,null ,'$fees','$services','$specializations','$user_id')");
                header("location:doctor-profile-setting.php?success");
                return;
            } else {
                mysqli_query($con,"update doctor set doc_contact='$addressLine',doc_location='$location' where doc_id='$doc_id'");
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Basic Information<small class="btn btn-sm bg-danger-light float-right <?php if ($failMessage==false){echo "d-none"; }?> ">Your profile setting has been not saved, go down to see the causes</small><small class="btn btn-sm bg-success-light float-right <?php if (!isset($_REQUEST['success'])){echo "d-none"; }?> ">Your profile setting updated successfully</small>
                                        <small class="btn btn-sm bg-success-light float-right <?php if (!isset($_REQUEST['uploaded'])){echo "d-none"; }?> ">Your photo is uploaded successfully</small>
                                    </h4>
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Contact</label>
                                                <input type="text" name="contact" value="<?php  echo $doctorRecordRow['doc_contact']; ?> " class="form-control" readonly>
                                            ...
                                            <div class="row form-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="addressLine"
                                                               value="<?php if (isset($_REQUEST['saveme'])) {
                                                                   ...
                                                                   echo $doctorRecordRow['doc_contact'];
                                                               } ?>" required>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <?php
                                                        $location=$doctorRecordRow['doc_location'];
                                                        ...
                                                        <select class="form-control select" name="province"
                                                                ...
                                                                <option value="Kabul" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Kabul") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Kabul"){
                                                                ...
                                                                <option value="Nangarhar" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Nangarhar") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Nangarhar"){
                                                                ...
                                                                <option value="Laghman" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Laghman") {
                                                                        echo "selected";
                                                                    }
                                                                }  elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Laghman"){
                                                                ...
                                                                <option value="Konar" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Konar") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Konar"){
                                                                ...
                                                                <option value="Logar" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Logar") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Logar"){
                                                                ...
                                                                <option value="Paktia" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Paktia") {
                                                                        echo "selected";
                                                                    }
                                                                }  elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Paktia"){
                                                                ...
                                                                <option value="Ghazni" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Ghazni") {
                                                                        echo "selected";
                                                                    }
                                                                }  elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Ghazni"){
                                                                ...
                                                                <option value="Herat" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Herat") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Herat"){
                                                                ...
                                                                <option value="Kandahar" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "kandahar") {
                                                                        echo "selected";
                                                                    }
                                                                }  elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Kandahar"){
                                                                ...
                                                                <option value="Balkh" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Balkh") {
                                                                        echo "selected";
                                                                    }
                                                                }  elseif (!isset($_REQUEST['saveme'])) {
                                                                    if ($list[2]=="Balkh"){
                                                            ...
                                                            if ($contactDetails==false) {
                                                                ?>
                                                                <option value="Peshawar" <?php if (isset($_REQUEST['saveme'])) {
                                                                    if ($_REQUEST['province'] == "Peshawar") {
                                                                        echo "selected";
                                                                    }
                                                                } elseif ($pro_des['profile_province'] == "Peshawar") {
                                                                    echo "selected";
                                                                } ?>>Peshawar (Pakistan)
                                                                </option>
                                                                <?php
                                                ...
                                                <div class="col-md-2" style="margin-top: 30px">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select" name="city" id="district">
                                                            ...
                                                            if (isset($_REQUEST['saveme'])) {
                                                                ?>
                                                                <option <?php if (isset($_REQUEST['city'])) {
                                                                    echo 'selected';
                                                                } ?>><?= $_REQUEST['city'] ?></option>
