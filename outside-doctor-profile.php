...
$user_id=$con->query("select user_id from users where user_username='$email'")->fetch_array()['user_id'];
...
if (isset($_SESSION['username'])){
    ...
    if (isset($_REQUEST['send'])){
        ...
        $to=$con->query("select * from users where user_username='$email'")->fetch_array()['user_id'];
        $date=date("Y-m-d h:i:s");


        if ($from==$to){
            header("location:outside-doctor-profile.php?username=$email&self");
            return;
        }elseif ($con->query("insert into chat_message values ('','$to','$from','$message','$date','not seen')")){
            header("location:outside-doctor-profile.php?username=$email&in");
            return;
        }else{
            header("location:outside-doctor-profile.php?username=$email&out");
            return;
        }
...
if (isset($_REQUEST['addreview'])) {
    ...
    if (isset($_SESSION['username'])){
        ...
        $user=$con->query("select * from users where user_username='$email'")->fetch_array();
        $user_id=$user['user_id'];
       $reviewer_id=$reviewer['user_id'];
       $reviewer_type=$reviewer['user_type'];
        ...
        elseif (($reviewer_type=='doctor') || ($reviewer_type=='outside doctor')){
            header("location:outside-doctor-profile.php?username=$email&showreviewsmodal&notallow");
            return;
        }
        elseif ($chckN==true){

            if ($con->query("insert into reviews values ('','$user_id','$reviewer_id','$reviewmsg','$date','$stars')")){
                header("location:outside-doctor-profile.php?username=$email&showreviewsmodal&saved");
                return;
            }
        }

    }else{
        header("location:outside-doctor-profile.php?username=$email&showreviewsmodal&noaccount");
        return;
    }
...
<head>
    <meta charset="utf-8">
    <title>Outside Doctor Profile - Health Guide</title>
                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            ...
                            <div class="doc-info-cont">
                                <h4 class="doc-name">Dr. <?php echo $doctorDetails['firstname'].' '.$doctorDetails['lastname']; ?></h4>
                                <h5 class="doc-department"><?=$doctorDetails['specialization']?></h5>
                        ...
                        <div class="doc-info-right">
                            <div class="clini-infos">
                                <ul>
                                    ...
                                    <li><i class="fas fa-map-marker-alt" title="Location"></i>  <?= $doctorDetails['location']?></li>
                                    <li><i class="far fa-money-bill-alt"></i> <?=$doctorProfile['profile_fees']?>-PKR Fees </li>
                                    <li><i class="fas fa-phone-alt"></i> <?=$doctorDetails['contact']?> </li>
                            ...
                            <div class="clinic-booking">
                                <a class="apt-btn" href="book-appointment-outside-doctor.php?doc_id=<?=$doctorDetails['id']?>">Book Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content pt-0">
                        ...
                        <div role="tabpanel" id="doc_reviews" class="tab-pane fade">
                            ...
                            <div class="write-review">
                                <h4>Write a message to <strong>Dr. <?php echo $doctorDetails['firstname'].' '.$doctorDetails['lastname'];?></strong></h4>

                                <!-- Write Review Form -->
                                <form action="outside-doctor-profile.php" method="post">
                                        ...
                                        <div class="widget-content">
                                            <div class="listing-hours">
                                                ...
                                                <div class="listing-day">
                                                    ...
                                                    <div class="time-items">
                                                        <?php
                                                        if (mysqli_num_rows($friSlot)>0){
                                                            while ($row=$friSlot->fetch_array()) {
                                                                ?>
                                                                <span class="time"> <?php echo $row['start_time']." - ".$row['end_time'] ?></span>
                                                                <?php
                                                            }}else{
                                        ...
                                        <div class="col-md-12 col-lg-6 login-right">
                                            ...
                                            <form action="index.php" method="post">
                                                ...
                                                <div class="text-right">
                                                    <a class="forgot-link" href="outside-doctor-profile.php?forgotpassword">Forgot Password ?</a>
                                                </div>
                                                ...
                                                <div class="text-center dont-have">Don’t have an account? <a href="outside-doctor-profile.php?registerLink">Register</a></div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 login-right">
                                            ...
                                            <form action="outside-doctor-profile.php" method="post">
                                                ...
                                                <div class="text-right">
                                                    <a class="forgot-link" href="outside-doctor-profile.php?haveaccount">Already have an account?</a>
                                                </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content loginModal">
            ...
            <div class="modal-body">
                ...
                <div class="widget review-listing">
                    <ul class="comments-list">
                        <?php
                        $email=$_REQUEST['username'];
                        $doc_user_id=$con->query("select * from users where user_username='$email'")->fetch_array()['user_id'];
                        $reviewDetails=$con->query("select * from reviews where profile_id='$doc_user_id'");
                        ...
                        while ($row=$reviewDetails->fetch_array()) {
                            ...
                            <li>
                                ...
                                <!-- Comment Reply -->
                                <ul class="comments-reply d-none">
                                    <li>
                                        <div class="comment">
                                            <img class="avatar avatar-sm rounded-circle" alt="User Image"
            ...
            <div class="modal-footer">
                <a href="outside-doctor-profile.php?username=<?=$email?>&review" class="btn btn-outline-primary">
    ...
    <div class="modal-dialog  modal-xl" role="document">
        <div class="modal-content loginModal">
            ...
            <div class="modal-body">
                ...
                <!-- Write Review -->
                <div class="write-review">
                    <h4>Write a review for <strong>Dr. <?=$doctorDetails['firstname'].' '.$doctorDetails['lastname']?></strong></h4>

                    <!-- Write Review Form -->
                    <form action="outside-doctor-profile.php" method="get">
                        <input type="hidden" name="username" value="<?=$doctorDetails['email']?>">
                        <div class="form-group">
