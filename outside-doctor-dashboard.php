...
if ((isset($_REQUEST['id'])) && (isset($_REQUEST['approve']))){
    ...
    if (mysqli_query($con,"update appointments set status='approved' where id='$id'")){
        header("location:outside-doctor-dashboard.php?approved");
        return;
    }else{
        header("location:outside-doctor-dashboard.php?notapproved");
        return;
    }
}
...
if (isset($_REQUEST['id'])){
    ...
    if (mysqli_query($con,"update appointments set status='deleted' where id='$id'")){
        header("location:outside-doctor-dashboard.php?deleted");
        return;
    }else{
        header("location:outside-doctor-dashboard.php?notdeleted");
        return;
    }
}
...
<head>
    <meta charset="utf-8">
    <title>Outside Doctor Dashboard - Health Guide</title>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <div class="table-action">
                                                                            <a href="outside-doctor-dashboard.php?id=<?= $row['id'] ?>&approve"
                                                                               class="btn btn-sm bg-info-light <?php if ($row['status']=='approved'){echo 'disabled';} ?>">
                                                                                <i class="fas fa-check"></i> Approve
                                                                            </a>
                                                                            <a href="outside-doctor-dashboard.php?id=<?= $row['id'] ?>"
                                                                        ...
                                                                        <h2 class="table-avatar">
                                                                            <a href="patient-profile.html"
                                                                               class="avatar avatar-sm mr-2"><img
                                                                                    ...
                                                                                    alt="No image"></a>
                                                                            <a href="patient-profile.html">Mr. <?= $patientDetails['user_name'] ?></a>
                                                                        </h2>
                                                                    </td>
