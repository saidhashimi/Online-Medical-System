...
$noSelect=true;
$msg=null;
$fromList=$con->query("select * from chat_message where to_user_id='$user_id' and status='not seen'");
...
$msgHistory=$con->query("select * from chat_message where from_user_id='$msg' and to_user_id='$user_id' or to_user_id='$msg' and from_user_id='$user_id'");
$fromListSeen=$con->query("select * from chat_message where to_user_id='$user_id' and status='seen'");
...
if (isset($_REQUEST['send'])){
    ...
    $mm=$_REQUEST['msg'];
    $con->query("insert into chat_message values ('','$mm','$user_id','$message','$date','not seen')");
    header("location:patient-chats.php?msg=$msg");
    return;
}
...
<head>
    <meta charset="utf-8">
    <title>Messenger - Health Guide</title>
                ...
                <div class="col-md-8 col-12">
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="patient-dashboard.php"> Dashboard</a> / chat messenger</li>
                        </ol>
                    </nav>
        ...
        <div class="messaging">
            <div class="inbox_msg">
                <div class="inbox_people">
                    ...
                    <div class="inbox_chat">
                        ...
                        while ($row=$fromList->fetch_array()) {
                            ...
                            */
                                $ms=$row['from_user_id'];
                                $selectLastMessage=$con->query("select * from chat_message where from_user_id='$ms' and to_user_id='$user_id' or to_user_id='$ms' and from_user_id='$user_id'");
                                ...
                                ?>
                                <a href="patient-chats.php?msg=<?= $row['from_user_id'] ?>">
                                    <div class="chat_list <?php if ($row['from_user_id'] == $msg) {
                                        echo 'active_chat';
                                    } ?>">
                                        <div class="chat_people">
                                            <div class="avatar avatar-sm float-left">
                                                <img src="assets/img/doctors/<?=$userImage?>" alt="User Image" class="avatar-img rounded-circle">
                                            </div>
                                            <div class="chat_ib">
                                                <h5><strong>Dr. <?= $userDetails['user_name'] ?><small class="ml-4 btn-sm rounded-circle bg-success-light"><strong><?=$counter?></strong></small> <span
                                                ...
                                                while ($rr=$selectLastMessage->fetch_array()){
                                                    ...
                                                    if (++$i==$lastRow){
                                                        if (($rr['to_user_id']==$msg) && ($rr['from_user_id']==$user_id)){
                                ...
                                <a href="patient-chats.php?msg=<?= $row['from_user_id'] ?>">
                                    <div class="chat_list <?php if ($row['from_user_id'] == $msg) {
                                        ...
                                        <div class="chat_people">
                                            ...
                                            <div class="chat_ib">
                                                <h5><strong>Dr. <?= $userDetails['user_name'] ?> </strong><span
                                                ...
                                                while ($rr=$selectLastMessage->fetch_array()){
                                                    ...
                                                    if (++$i==$lastRow){
                                                        if (($rr['to_user_id']==$ms) && ($rr['from_user_id']==$user_id)){
                                                            $selectMessage='You: '.$rr['message'];
                                                        }else{
                                                            $selectMessage=$rr['message'];
                                                        }
                ...
                <div class="mesgs <?php if ($noSelect==true){echo 'd-none';} ?>">
                    ...
                    <form action="patient-chats.php" method="post">
                        <div class="type_msg">
