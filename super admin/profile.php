...
$super=$con->query("select * from users where user_type='super admin'")->fetch_array();
...
$msgE=false;
    ...
    if (isset($_REQUEST['update'])){
        ...
        }if (($chckN==true) && ($chckA==true) && ($chckC==true) && ($chckE==true)) {
            if (mysqli_query($con, "update users set user_name='$name',user_username='$username',user_address='$address',user_contact='$contact' where user_type='super admin'")) {
...
<head>
    ...
    <title> Profile Setting - Super Admin</title>
        ...
        <div class="content container-fluid">
            ...
            <div class="mohaForms" id="doctorRegistration">
                ...
                <form action="profile.php" method="post">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Profile Setting <small class="float-right btn btn-sm bg-success-light <?php if (!isset($_REQUEST['updated'])){echo 'd-none';} ?>">Updated Successfully !</small>
                                <small class="float-right btn btn-sm bg-danger-light <?php if (!isset($_REQUEST['notupdated'])){echo 'd-none';} ?>">Not Updated !</small>
                            </h4>
                            ...
                            <div class="row form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($msgN==true){echo "bg-danger-light";} ?>" name="name" minlength="5" maxlength="40"  value="<?php if (isset($_REQUEST['name'])){echo $_REQUEST['name'];}else{echo $super['user_name'];} ?>" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="<?php if (isset($_REQUEST['username'])){echo $_REQUEST['username'];} else { echo $super['user_username']; }?>" class="form-control <?php if ($msgE==true){echo "bg-danger-light";} ?>" name="username" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($msgA==true){echo "bg-danger-light";} ?>" name="address" value="<?php if (isset($_REQUEST['address'])){echo $_REQUEST['address'];}else{echo $super['user_address'];} ?>" minlength="5" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?php if ($msgSelectCon==true){echo "bg-danger-light";} ?>" name="contact" value="<?php  if (isset($_REQUEST['contact'])){echo $_REQUEST['contact'];}else{echo $super['user_contact'];}  ?>" required>
                                ...
                                <div class="submit-section" style="position: relative; margin-left: 450px; margin-right: 400px;">

                                    <button type="submit" class="btn bg-success-light"  name="update">Update</button>
