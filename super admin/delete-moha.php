...
$superAdminImage=$con->query("select file_name from pictures where user_id='$super_user_id'")->fetch_array()['file_name'];
    ...
    $mohaAccounts=$con->query("select * from users where user_type='moha'");
    ...
    if (isset($_REQUEST['delete'])){
        ...
        if (mysqli_query($con,"delete from users where user_id='$user_id'")){
            header("location:delete-moha.php?deleted");
            return;
        }else{
            header("location:delete-moha.php?notdeleted");
            return;
        }
...
<head>
    ...
    <title>Health Guide - Super Admin</title>
                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="invoice-report.html">Register Outside Doctor</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a class="active" href="delete-moha.php">Delete MOHA</a></li>
                        </ul>
                    </li>
                    <li class="menu-title">
                ...
                <div class="col-md-12 d-flex">
                    ...
                    <div class="card card-table flex-fill" style="overflow-y:scroll; overflow-x:hidden; height:800px;">
                        <div class="card-header">
                            <h4 class="card-title">MOHA-Employee List <small class="float-right btn btn-sm bg-success-light <?php if (!isset($_REQUEST['deleted'])){echo 'd-none'; } ?>">Deleted Successfully !</small> </h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <?php
                                    while ($row=$mohaAccounts->fetch_array()) {

                                        ?>
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a> Mr. <?=$row['user_name']?></a>
                                                </h2>
                                            </td>
                                            <td><?=$row['user_username']?></td>
                                            <td><?=$row['user_address']?></td>
                                            <td><?=$row['user_contact']?></td>
                                        <form action="delete-moha.php" method="post">

                                            <td>
                                                <button class="btn btn-sm bg-danger-light" name="delete" value="<?=$row['user_id']?>"><i class="fe fe-trash"></i>
                                                </button>
                                            </td>
                                        </form>
                                        </tr>
