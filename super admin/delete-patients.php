...
$superAdminImage=$con->query("select file_name from pictures where user_id='$super_user_id'")->fetch_array()['file_name'];
    ...
    $patientList=mysqli_query($con,"select * from users where user_type='patient'");
    ...
    if (isset($_REQUEST['delete'])){
        ...
        if (mysqli_query($con,"delete from users where user_id='$user_id'")){
            header("location:delete-patients.php?deleted");
            return;
        }else{
            header("location:delete-patients.php?notdeleted");
            return;
        }
...
<head>
    ...
    <title>Delete Patient - Super Admin</title>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="active">
                        <a class="active" href="delete-patients.php"><i class="fe fe-user"></i> <span>Patients</span></a>
                    </li>
                    <li>
                ...
                <div class="col-md-12 d-flex">
                    ...
                    <div class="card card-table flex-fill" style="overflow-y:scroll; overflow-x:hidden; height:800px;">
                        <div class="card-header">
                            <h4 class="card-title">Patients Account List <small class="float-right btn btn-sm bg-success-light <?php if (!isset($_REQUEST['deleted'])){echo 'd-none'; } ?>">Deleted Successfully !</small></h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    while ($row=$patientList->fetch_array()) {
                                        ...
                                        <tr>
                                            ...
                                            <form method="post" action="delete-patients.php">
