...
if (isset($_REQUEST['patientid'])){
    ...
    if (mysqli_query($con,"update appointments set status='deleted' where id='$id'")){
        header("location:outside-doctor-appointments.php?deleted");
        return;
    }else{
        header("location:outside-doctor-appointments.php?notdeleted");
        return;
    }
...
if (isset($_REQUEST['sendmessage'])){
    ...
    if ($con->query("insert into chat_message values ('','$touser','$from','$message','$date','not seen')")){
        header("location:outside-doctor-appointments.php?send");
        return;
    }else{
        header("location:outside-doctor-appointments.php?notsend");
        return;
    }
...
<head>
    <meta charset="utf-8">
    <title>Outside Doctor Appointments - Health Guide</title>
                                ...
                                if (!$row['visitor_id'] == '') {
                                    ...
                                    <div class="appointments" style="margin-top: 30px">
                                        ...
                                        <div class="appointment-list">
                                            <div class="profile-info-widget">
                                                ...
                                                <div class="profile-det-info">
                                                    <h3>
                                                        <a>Mr. <?= $patientDetails['name'] ?> <small class="">(Visitor)</small></a>
                                                    </h3>
                                                    <div class="patient-details">
                                            ...
                                            <div class="appointment-action">
                                                ...
                                                <a href="outside-doctor-appointments.php?visitorid=<?= $patientDetails['id'] ?>"
                                    ...
                                    <div class="appointments">
                                        ...
                                        <div class="appointment-list">
                                            ...
                                            <div class="appointment-action">
                                                <a href="outside-doctor-appointments.php?message&touser=<?=$patientDetails['user_id']?>"
                                                   class="btn btn-sm bg-primary-light">
                                                    <i class="fas fa-envelope"></i> Message
                                                </a>
                                                <a href="outside-doctor-appointments.php?patientid=<?=$row['id']?>"
                                                   class="btn btn-sm bg-danger-light">
                                                    <i class="fas fa-times"></i> Cancel
                                                </a>
                                            </div>
                                ...
                                <div class="account-content">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 login-right">
                                            ...
                                            <form action="outside-doctor-appointments.php" method="post">
