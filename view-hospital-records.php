...
elseif (isset($_REQUEST['viewbyname'])){
    ...
    $hospitalRecordRow=$con->query("select * from hospital where hos_name LIKE '%$hosName%'");
    $chkRowsCount=mysqli_num_rows($hospitalRecordRow);
...
elseif (isset($_REQUEST['viewbylocation'])){
    ...
    if ($hosLocation=="View by location"){
        $msgP=true;
    }elseif ($chkRowsCount==0){
        $viewHospitalRecordEmpty=true;
    }
...
<head>
    <meta charset="utf-8">
    <title>View Hospital Records - MOHA</title>
        ...
        <div class="card doctor-view">
            <div class="card-body">
                <div class="user-tabs">
                    ...
                    <!--View Button Records-->
                    <div class="table-responsive hospitalList2View"  style="display: <?php if($viewHospitalRecord==false){ echo "none"; }  ?>">
                        <form action="view-hospital-records.php" method="post">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==false){ echo "active"; } ?>" href="#hos-view" data-toggle="tab" >View Hospitla Records</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==true){ echo "active"; } ?> " href="#hos-view-by" data-toggle="tab"><span>View Hospital Record By</span></a>
                        </li>
                ...
                <div class="tab-content">
                    ...
                    <div id="hos-view" class="tab-pane fade show <?php  if ($view==false){ echo "active"; }  ?>">
                        <div class="card card-table mb-0">
                            <div class="card-body">
                                <div class="table-responsive hospitalListView">
                                    <table class="table table-hover table-center mb-0">
                                        <thead>
                                        <tr>
                                            <th>Hospital Name</th>
                    ...
                    <!--Hospital View By-->
                    <div id="hos-view-by" class="tab-pane fade show hospitalListView <?php if ($view==true){ echo "active"; }  ?>">
                        <div class="card card-table mb-0">
                            <div class="card-body">
                                <form method="post" action="view-hospital-records.php?hospitalID" style="position: relative; margin-top: 20px;">
                                ...
                                <form action="view-hospital-records.php?hospitalName" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <input type="text" class="form-control <?php if ($msgN==true){echo "bg-danger-light";} ?>"  placeholder="enter hospital name here.." value="<?php if (isset($_REQUEST['hosName'])){echo $_REQUEST['hosName'];} ?>" name="hosName" required>
                                ...
                                <form action="view-hospital-records.php?hospitalLocation" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <select class="form-control select" name="hosLocation">
