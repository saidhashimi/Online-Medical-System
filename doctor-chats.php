 ...
 */
    ...
    if (isset($_REQUEST['send'])){
        ...
        header("location:doctor-chats.php?msg=$msg");
        return;
    }
                ...
                <div class="col-md-8 col-12">
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="doctor-dashboard.php"> Dashboard</a> / chat messenger</li>
                        </ol>
                    </nav>
        ...
        <div class="messaging">
            <div class="inbox_msg">
                        ...
                        <?php
                            ...
                            while ($row=$fromList->fetch_array()) {
                                ...
                                */
                                    ...
                                    ?>
                                    <a href="doctor-chats.php?msg=<?= $row['from_user_id'] ?>">
                ...
                <div class="mesgs <?php if ($noSelect==true){echo 'd-none';} ?>">
                    ...
                    <form action="doctor-chats.php" method="post">
                    <div class="type_msg">
