                    ...
                    <div class="card success-card">
                        <div class="card-body">
                            <div class="success-cont">
                                ...
                                <p>Appointment booked with  <strong style="margin-left: 3px;"> Dr. <?php echo $doctorDetails['doc_firstName'].' '.$doctorDetails['doc_lastName']; ?></strong></p><br>

                                <a href="appointment-success.php?done" class="btn btn-primary view-inv-btn">Done</a>
                            </div>
                        </div>
                    </div>
                    <!-- /Success Card -->
