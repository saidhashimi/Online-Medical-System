...
//Search Working
$hospitalDetails=$con->query("select * from medicals");
$msgN=false;
$nameShow=false;
$provinceshow=false;
$typeprovince=false;
...
if (isset($_REQUEST['search'])){
    ...
    if (($name==null) && ($location=="Select")){
        header("location:search-medicals.php");
        return;
    }elseif (!preg_match("/^[a-zA-Z ]*$/",$name)){
        $msgN=true;
    }elseif (($name!=null) && ($location=="Select")){
        $hospitalDetails=$con->query("select * from medicals where medical_name='$name'");
        $nameShow=true;
    }elseif (($location!="Select") && ($name==null)){
        $hospitalDetails=$con->query("select * from medicals where medical_location like '%$location%'");
        $provinceshow=true;

    }elseif (($location!="Select") && ($name!=null)){
        $hospitalDetails=$con->query("select * from medicals where medical_name like '%$name%' and medical_location like '%$location%'");
        $namelocation=true;
...
<head>
    <meta charset="UTF-8">
    <title>Search Medical Stores - Health Guide</title>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8 col-12">
                    <?php
                    if ($nameShow==true){
                        echo "<h3 style='color: white'> Searching: ".$name." medical store </h3>";
                    }elseif ($provinceshow==true){
                        echo "<h3 style='color: white'> Searching: Medicals in ".$location." </h3>";
                    }elseif ($typeshow==true){
                        echo "<h3 style='color: white'> Searching:".$type." Medical </h3>";
                    }elseif ($typeprovince==true){
                        echo "<h3 style='color: white'> Searching: ".$type." medical store in ".$location." </h3>";

                    }elseif ($namelocation==true){
                        echo "<h3 style='color: white'> Searching: ".$name." medical store in ".$location." </h3>";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar">
                    ...
                    <!-- Search Filter -->
                    <form action="search-medicals.php" method="get">
                                ...
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        <div class="doctor-img">
                                            <a>
                                                <img src="assets/img/services/med.png" class="img-fluid"
                                                     alt="Doctor Image">
                                            </a>
                                        </div>
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name bg-s"><a> <?php echo $row['medical_name']  ?> Medical Store</a></h4>
                                         <br>
                                    ...
                                    <div class="doc-info-right">
                                        <div class="clini-infos">
                                            <ul>
                                                <li><i class="fas fa-check"></i> <?php  echo $row['medical_status']; ?> by MOHA</li>

                                                <li title="Location"><i class="fas fa-map-marker-alt"
                                                                        data-toggle="tooltip" title="Location"></i>
                                                    <?php
                                                    echo $row['medical_location'];
                                                    ?>
                                                </li>
