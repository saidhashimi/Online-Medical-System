...
<?php
    ...
    $doc_user_id=$con->query("select user_id from users where doc_id='$doc_id'")->fetch_array()['user_id'];
                        ...
                        <div class="card-body">
                            <div class="booking-doc-info">
                                ...
                                <div class="booking-info">
                                    <h4><a href="doctor-profile.php?doc_id=<?=$doctorDetails['doc_id']?>">Dr. <?php
                                            echo $doctorDetails['doc_firstName'].' '.$doctorDetails['doc_lastName'];
                                            ?></a></h4>
                                    <p class="text-muted mb-0"><i class="fas fa-check" style="margin-right: 10px"></i><?=$doctorDetails['doc_status']?> by MOHA</p>
                                    <br>
                                    <p class="text-muted mb-0"><i class="fas fa-map-marker-alt" style="margin-right: 10px"></i> <?php echo $doctorDetails['doc_location']; ?>, Afghanistan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <ul class="clearfix">
                                            <li>
                                                ...
                                                while($row=$doctorSatSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$satDate?>">
                                            ...
                                            <li>
                                                ...
                                                while($row=$doctorSunSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$sunDate?>">
                                                        <span><?php echo $row['start_time']."-".$row['end_time']; ?></span>
                                                    </a>
                                                    <?php
                                                }
                                            ...
                                            <li>
                                                ...
                                                while($row=$doctorMonSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$monDate?>">
                                                        <span><?php echo $row['start_time']."-".$row['end_time']; ?></span>
                                                    </a>
                                                    <?php
                                                }
                                            ...
                                            <li>
                                                ...
                                                while($row=$doctorTueSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$tueDate?>">
                                                        <span><?php echo $row['start_time']."-".$row['end_time']; ?></span>
                                                    </a>
                                                    <?php
                                                }
                                            ...
                                            <li>
                                                ...
                                                while($row=$doctorWedSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$wedDate?>">
                                                        <span><?php echo $row['start_time']."-".$row['end_time']; ?></span>
                                                    </a>
                                                    <?php
                                                }
                                            ...
                                            <li>
                                                ...
                                                while($row=$doctorThuSlots->fetch_array()) {
                                                    ?>
                                                    <a class="timing" href="visitor.php?startTime=<?=$row['start_time']?>&endTime=<?=$row['end_time']?>&date=<?=$thuDate?>">
                                                        <span><?php echo $row['start_time']."-".$row['end_time']; ?></span>
                                                    </a>
                                                    <?php
                                                }
