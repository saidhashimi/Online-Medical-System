...
if (isset($_REQUEST['sendmessage'])){
    ...
    if ($con->query("insert into chat_message values ('','$touser','$from','$message','$date','not seen')")){
        header("location:doctor-patients.php?send");
        return;
    }else{
        header("location:doctor-patients.php?notsend");
        return;
    }
...
<head>
    <meta charset="utf-8">
    <title>Doctor Patients - Health Guide</title>
                                                ...
                                                <div class="card widget-profile pat-widget-profile">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="patient-info text-md-center">
                                                            <a href="doctor-patients.php?message&touser=<?=$patientDetails['user_id']?>"
                                ...
                                <div class="account-content">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 login-right">
                                            ...
                                            <form action="doctor-patients.php" method="post">
