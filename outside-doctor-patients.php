...
$appointments=$con->query("select distinct user_id,visitor_id from appointments where doc_user_id='$doc_user_id'");
$msgModal=false;
...
if (isset($_REQUEST['sendmessage'])){
    ...
    if ($con->query("insert into chat_message values ('','$touser','$from','$message','$date','not seen')")){
        header("location:outside-doctor-patients.php?send");
        return;
    }else{
        header("location:outside-doctor-patients.php?notsend");
        return;
    }
...
<head>
    <meta charset="utf-8">
    <title>Outside Doctor Patients - Health Guide</title>
                                            ...
                                            <div class="card widget-profile pat-widget-profile">
                                                <div class="card-body">
                                                    <div class="pro-widget-content">
                                                        <div class="profile-info-widget">
                                                            <a  class="booking-doc-img">
                                                                <img src="assets/img/patients/visitor.png"
                                                                     alt="No Visitor Image">
                                                            </a>
                                                            <div class="profile-det-info">
                                                                <h3>
                                                    ...
                                                    <div class="patient-info">
                                                        <ul>
                                                            <li>Phone <span><?= $patientDetails['contact'] ?></span>
                                                            </li>
                                                            <br>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="card widget-profile pat-widget-profile">
                                                <div class="card-body">
                                                        ...
                                                        <div class="profile-info-widget">
                                                            ...
                                                            <div class="profile-det-info">
                                                                ...
                                                                <div class="patient-details">
                                                                    ...
                                                                    <h5 class="mb-0"><i
                                                                            class="fas fa-map-marker-alt"></i>
                                                                        <?=$patientDetails['user_address']?>, Afghanistan</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="patient-info">
                                                        <ul>
                                                            <li>Phone <span><?= $patientDetails['user_contact'] ?></span>
                                                            </li>
                                                    ...
                                                    <div class="patient-info text-md-center">
                                                        <a href="outside-doctor-patients.php?message&touser=<?=$patientDetails['user_id']?>"
                                ...
                                <div class="account-content">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="col-md-12 col-lg-6 login-right">
                                            ...
                                            <form action="outside-doctor-patients.php" method="post">
