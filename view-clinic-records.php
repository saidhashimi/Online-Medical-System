...
elseif (isset($_REQUEST['viewbytype'])){
    $view=true;
    $cliType=$_REQUEST['cliType'];
    $clinicRecordRow=$con->query("select * from clinics where clinic_type='$cliType'");
    $chkRowsCount=mysqli_num_rows($clinicRecordRow);


    if ($cliType=="Select by a clinic type"){
        $msgS=true;
    }elseif ($chkRowsCount==0){
        $viewClinicRecordEmpty=true;
    }
...
elseif (isset($_REQUEST['viewbylocation'])){
    ...
    if ($cliLocation=="View by location"){
        $msgP=true;
    }elseif ($chkRowsCount==0){
        $viewClinicRecordEmpty=true;
    }
...
<head>
    <meta charset="utf-8">
    <title>View Clinic Records - MOHA</title>
        ...
        <div class="card doctor-view">
            <div class="card-body">
                <div class="user-tabs">
                    <div style="margin-left: 30%;color: green;font-weight: 700; display: <?php if ($viewClinicRecord==false){ echo "none";}  ?>">
                        <span>  <i class="fas fa-check" style="margin-right: 3px"></i><?php if (isset($_REQUEST['clinicID'])){?> Clinic Record By  Search ID = <?php echo $_REQUEST['cli_id']; } ?>
                            ...
                            <?php if (isset($_REQUEST['clinicType'])){?> Clinic Record   Search By Type = <?php echo $_REQUEST['cliType']; ?>   <?php } ?>
                    ...
                    <div style="margin-left: 30%;color: red;font-weight: 700; ;display: <?php if ($viewClinicRecordEmpty==false){ echo "none";}  ?>">
                        <span>  <i class="far fa-window-close" style="margin-right: 3px"></i>
                            ...
                            <?php if (isset($_REQUEST['clinicType'])){?>  No Clinic Record Avaliable By Type = <?php echo $_REQUEST['cliType']; } ?>

                        </span>
                    </div>
                    <!--View Button Records-->
                    <div class="table-responsive clinicList2View"  style="display: <?php if($viewClinicRecord==false){ echo "none"; }  ?>">
                        <form action="view-clinic-records.php" method="post">
                                    ...
                                    <tr class="clinicRowView">
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="doctor-profile.html"> <?php echo $clinicRecordRow['clinic_name'] ?>
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==false){ echo "active"; } ?>" href="#cli-view" data-toggle="tab" >View Clinics Records</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if($view==true){ echo "active"; } ?> " href="#cli-view-by" data-toggle="tab"><span>View Clinic Record By</span></a>
                        </li>
                ...
                <div class="tab-content">
                    <!--View Clinic Record Tab-->
                    <div id="cli-view" class="tab-pane fade show <?php  if ($view==false){ echo "active"; }  ?>">
                        <div class="card card-table mb-0">
                            <div class="card-body">
                                <div class="table-responsive clinicListView">
                                    <table class="table table-hover table-center mb-0">
                                        <thead>
                                        <tr>
                                            <th>Clinic Name</th>
                    ...
                    <!--Clinic View By-->
                    <div id="cli-view-by" class="tab-pane fade show clinicListView <?php if ($view==true){ echo "active"; }  ?>">
                        <div class="card card-table mb-0">
                            <div class="card-body">
                                <form method="post" action="view-clinic-records.php?clinicID" style="position: relative; margin-top: 20px;">
                                ...
                                <form action="view-clinic-records.php?clinicName" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <input type="text" class="form-control" placeholder="enter clinic name here.." value="<?php if (isset($_REQUEST['cliName'])){echo $_REQUEST['cliName'];} ?>" name="cliName" required>
                                ...
                                <!---View Clinic Record by Type-->
                                <form action="view-clinic-records.php?clinicType" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <select class="form-control select" name="cliType">
                                                    <option>Select by a clinic type</option>
                                                    <option>Eye</option>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group" style="position: relative;margin-top: 4px;">
                                                <button  name="viewbytype" class="btn btn-md bg-success-light">
                                                    <i class="far fa-eye"></i> View Record
                                                </button>
                                ...
                                <form action="view-clinic-records.php?clinicLocation" method="post">
                                    <div class="row form-row">

                                        <div class="col-md-6" style="position: relative;margin-left: 20px;">
                                            <div class="form-group">

                                                <select class="form-control select" name="cliLocation">
                                                    <option>View by location</option>
                                                    <option>Kabul</option>
