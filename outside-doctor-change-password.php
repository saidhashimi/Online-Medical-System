...
if (!isset($_SESSION['username'])){
    ...
    if (!password_verify($oldPassword,$selectOldPassword)){
        ...
        header("location:outside-doctor-change-password.php?changed");
        return;
    }
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="dashboard-widget">
                            <nav class="dashboard-menu">
                                <ul>
                                    <li>
                                        <a href="outside-doctor-dashboard.php" onclick="dashboard();">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 col-lg-6">
                                            ...
                                            <form action="outside-doctor-change-password.php" method="post">
