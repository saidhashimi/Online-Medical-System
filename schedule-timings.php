...
if (!isset($_COOKIE['username'])){
    ...
    if (isset($_REQUEST['save'])){
        ...
        if ($_REQUEST['day']=='sat'){
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?avaliable");
                return;
                ...
                header("location: schedule-timings.php?fail");
                return;
            }else{
                    header("location: schedule-timings.php?success");
                    return;
            }
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?day=sun&avaliable");
                return;
                ...
                header("loction: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=sun&success");
                return;
            }
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?day=mon&avaliable");
                return;
                ...
                header("location: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=mon&success");
                return;
            }
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?day=tue&avaliable");
                return;
                ...
                header("location: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=tue&success");
                return;
            }
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?day=wed&avaliable");
                return;
                ...
                header("location: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=wed&success");
                return;
            }
            ...
            if ($checkingslot>0){
                header("location:schedule-timings.php?day=thr&avaliable");
                return;
                ...
                header("location: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=thr&success");
                return;
            }
            ...
            if (!$result=mysqli_query($con,"insert into doctorslots values ('$doctorID','$startTime','$endTime',null ,null ,null ,null ,null ,null ,'yes')")){
                header("location: schedule-timings.php?fail");
                return;
            }else{ header("location: schedule-timings.php?day=fri&success");
                return;
            }
        }
    ...
    elseif (isset($_REQUEST['dd'])){
        ...
        if(!$result=mysqli_query($con,"delete from doctorslots where start_time='$start_time' and end_time='$end_time' and ".$dd."='yes'")){
            header("location: schedule-timings.php?deletefail");
            return;
        }else{
            $day=$_REQUEST['day'];
            header("location:schedule-timings.php?day=$day&deleted");
            return;
        }
    }
...
<head>
    <meta charset="utf-8">
    <title>Doctor Timings - Health Guide</title>
                            ...
                            <div class="profile-info-widget">
                                ...
                                <div class="profile-det-info">
                                    ...
                                    <div class="patient-details">
                                        <h5 class="mb-0"><?=$doctorDetails['doc_specialization']?> - <?=$doctorDetails['doc_qualification']?> </h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                            ...
                                                            <div class="tab-content schedule-cont">
                                                                ...
                                                                <div id="slot_saturday" class="tab-pane fade <?php  if (!isset($_REQUEST['day'])){  ?> show active <?php }elseif ($_REQUEST['day']=='sat'){ ?> show active <?php  } ?> ">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        ...
                                                                        <a class="edit-link"  href="schedule-timings.php?day=sat&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            while($row=$saturdaySlots->fetch_array()) {
                                                                                ...
                                                                                <div class="doc-slot-list">
                                                                                    <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                    <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=saturday&day=sat"
                                                                ...
                                                                <div id="slot_sunday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) &&($_REQUEST['day']=='sun')){ ?> show active <?php  } ?>">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        <span>Time Slots</span>
                                                                        <a class="edit-link"  href="schedule-timings.php?day=sun&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$sundaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                  <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=sunday&day=sun"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
                                                                ...
                                                                <div id="slot_monday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) && ($_REQUEST['day']=='mon')){ ?> show active <?php  } ?>">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        <span>Time Slots</span>
                                                                        <a class="edit-link"  href="schedule-timings.php?day=mon&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$mondaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                 <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=monday&day=mon"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
                                                                ...
                                                                <div id="slot_tuesday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) && ($_REQUEST['day']=='tue')){ ?> show active <?php  } ?>">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        <span>Time Slots</span>
                                                                        <a class="edit-link"  href="schedule-timings.php?day=tue&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$tuesdaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=tuesday&day=tue"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
                                                                ...
                                                                <div id="slot_wednesday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) && ($_REQUEST['day']=='wed')){ ?> show active <?php  } ?>">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        <span>Time Slots</span>
                                                                        <a class="edit-link"  href="schedule-timings.php?day=wed&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$wednesdaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                 <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=wednesday&day=wed"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
                                                                ...
                                                                <div id="slot_thursday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) && ($_REQUEST['day']=='thr')){ ?> show active <?php  } ?> ">
                                                                    <h4 class="card-title d-flex justify-content-between">
                                                                        <span>Time Slots</span>
                                                                        <a class="edit-link"  href="schedule-timings.php?day=thr&show" ><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                    </h4>
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$thursdaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <?php echo $row['start_time']." - ".$row['end_time']; ?>                                                                                <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=thursday&day=thr"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
                                                                ...
                                                                <div id="slot_friday" class="tab-pane fade <?php if ((isset($_REQUEST['day'])) && ($_REQUEST['day']=='fri')){ ?> show active <?php  } ?>">
                                                                    ...
                                                                    <div class="doc-times">
                                                                        ...
                                                                        while($row=$fridaySlots->fetch_array()) {
                                                                            ...
                                                                            ?>
                                                                            <div class="doc-slot-list">
                                                                                <a href="schedule-timings.php?start_time=<?=$row['start_time']?>&end_time=<?=$row['end_time']?>&dd=friday&day=fri"
                                                                                   class="delete_schedule">
                                                                                    <i class="fa fa-times"></i>
                                                                                </a>
                                                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="schedule-timings.php">
